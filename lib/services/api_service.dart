...
class ApiService {
  ...
  factory ApiService({String? authToken}) {
    if (_instance != null && authToken != null && authToken != _instance!.authToken) {
      _instance!.authToken = authToken;
      _instance!._core.updateAuthToken(authToken);
      _instance!._tokenService.updateAuthToken(authToken);
    }
    return instance;
  }
  ...
  void _initializeServices() {
    ...
    _core.onTokenRefresh = _refreshToken;
