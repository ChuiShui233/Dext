            ...
            child: FDialog(
                    ...
                    FTextField(
                      ...
                      description: Text(
                        nameController.text.trim().isNotEmpty &&
                                _projects.any((p) => p.projectName.toLowerCase() == nameController.text.trim().toLowerCase())
                            ? '已存在同名项目'
                            : '',
              ...
              actions: [
                FButton(
                  ...
                  onPress: isSubmitting ? null : () => Navigator.pop(context),
                  child: const Text('取消'),
                ),
                FButton(
                          ...
                          try {
                            ...
                            if (mounted) {
                              showFToast(
                                ...
                                description: Text('项目 “$trimmedName” 已创建，正在刷新列表...'),
                  ...
                  child: Text(isSubmitting ? '创建中...' : '确定'),
                ),
              ],
            ),
          ),
