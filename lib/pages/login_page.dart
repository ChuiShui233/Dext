  ...
  Widget _buildLoginForm() {
    ...
    final loginContent = Column(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        if (googleClientId.isNotEmpty || githubClientId.isNotEmpty || microsoftClientId.isNotEmpty) ...[
          Row(
            children: [
              Expanded(
                child: Container(
          ...
          const SizedBox(height: 24),
          if (googleClientId.isNotEmpty || githubClientId.isNotEmpty)
            Row(
              children: [
                ...
                if (googleClientId.isNotEmpty && githubClientId.isNotEmpty)
                  const SizedBox(width: 12),
                if (githubClientId.isNotEmpty)
                  Expanded(
                    child: _buildOAuthButton(
                      onTap: _handleGitHubLogin,
                      svgAsset: 'assets/svg/github.svg',
                      label: 'GitHub',
                    ),
                  ),
              ],
          ...
          if (microsoftClientId.isNotEmpty)
            _buildOAuthButton(
              onTap: _handleMicrosoftLogin,
              svgAsset: 'assets/svg/microsoft.svg',
              label: 'Microsoft',
            ),
        ],
      ],
